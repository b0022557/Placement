	...
	<body>
		...
		<div id="show-student" class="content scaffold-show" role="main">
			...
			<ol class="property-list student">
				...
				<g:if test="${studentInstance?.course_code}">
				<li class="fieldcontain">
					<span id="course_code-label" class="property-label"><g:message code="student.course_code.label" default="Coursecode" /></span>
					
						<span class="property-value" aria-labelledby="course_code-label"><g:fieldValue bean="${studentInstance}" field="course_code"/></span>
