			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="course_code" title="${message(code: 'student.course_code.label', default: 'Coursecode')}" />
				...
				<g:each in="${studentInstanceList}" status="i" var="studentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: studentInstance, field: "course_code")}</td>
